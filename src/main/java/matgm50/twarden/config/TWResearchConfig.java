...
public class TWResearchConfig {
	...
	public static final String TWCATEGORY = TWModConfig.TWMOD_ID.toUpperCase();
	public static final ResourceLocation TWCATEGORY_ICON = new ResourceLocation(TWModConfig.TWMOD_ID.toLowerCase() ,"textures/items/wardensigil.png");
